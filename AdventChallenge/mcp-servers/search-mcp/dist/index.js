...
const TOOLS = [
    {
        name: "search",
        description: "Search Wikipedia for information on a topic. Returns article title, summary extract, and URL.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
...
async function callSearch(rawArguments) {
    ...
    try {
        ...
        const queryResult = searchData.query;
